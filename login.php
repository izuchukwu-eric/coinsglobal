    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="block">
                    <h2 class="text-center">Sign In to Coinsglobals</h2>
                    
                    <form class="text-left clearfix mt-50" name="mainform" onsubmit="return checkform()" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">

                            <?php
                            
                            if(isset($_SESSION['login_error']) && $_SESSION['login_error'] !='') {

                                echo '<h6 style="color: red"> '.$_SESSION['login_error'].' </h6>';
                        ...
                        <button type="submit" id="submit" class="btn btn-main" name="login" >LOGIN</button>
