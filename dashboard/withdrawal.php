    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="active"><a href="withdrawal.php"><i class="ft-credit-card"></i><span class="menu-title" data-i18n="">Withdraw Funds</span></a>
          </li>
              ...
              <div class="card-header">
                ...
                <div class="card-content collapse show">
                   ...
                   <form  action="code.php" method="POST" >
                      <span>Enter Withdrawal Method:</span>
                      <input type="text" class="form-control" name="coin" ></br></br>
                     
                      <span>Enter Wallet Address:</span>
                      <input type="text" name="wallet" class="form-control"  placeholder="enter wallet address" ></br></br>

                      <span>Amount</span>
                      <input type="number" class="form-control" name="amount" ></br></br>

                      <button class="btn" style="background-color: #007F5F; color: #ffffff; " type="submit" name="withdraw_btn">Withdraw</button> 
                      </form> 
                   </div>
                </div>
             </div>
