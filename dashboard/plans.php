    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" active"><a href="plans.php"><i class="ft-layers"></i><span class="menu-title" data-i18n="">Investment Plans</span></a>
          </li>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Investment Plans</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Plans
                  </li>
                </ol>
              </div>
            </div>
      ...
      <div class="col-12">
          <div class="card">
              <div class="card-header">
                  <h4 class="card-title">Choose an investment plan</h4>
            ...
            <div class="col-md-3 p-1">
                <h5>STANDARD PLAN</h5>
                <P>
                    1.5% profit daily for 3days
                    minimum $200</br>
                    maximum unlimited</br>
                    instant payments</br>
                    capital return
                </p>
                <a href="deposit.php">
            <button class="btn" style="background-color: #007F5F; color: #ffffff; ">Add Funds</button>
                </a>
            </div>
            <div class="col-md-3 p-1">
            <h5>PREMIUM PLAN</h5>
                <P>
                    2.0% profit daily for 15days
                    minimum $3000</br>
                    maximum unlimited</br>
                    instant payments</br>
                    capital return
