                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link" href="contact.php">Support <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="title text-center">
                        ...
                        <p>Any problem?...Send us a message.</p>
                        ...
                        <?php
                            ...
                            if(isset($_SESSION['message']) && $_SESSION['message'] !='') {
                                ...
                                echo '<h6 style="color: green"> '.$_SESSION['message'].' </h6>';
			...
			<div class="row">
				...
				<div class="contact-form col-12 col-md-6  mx-auto" >
					<form id="contact-form" method="post" action="sendmail.php" role="form" onsubmit="return checkform()" name="mainform">
